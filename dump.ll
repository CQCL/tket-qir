...
entry:
  ...
  %c = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 2)
  ...
  call void @Microsoft__Quantum__Intrinsic__X__ctl(%Array* %__controlQubits__, %Qubit* %q1)
  ...
  %existing_value2 = load %Result*, %Result** %c1_result_1, align 8
  ...
  store %Result* %measurement1, %Result** %c1_result_1, align 8
